...
n=400 # N doit être divisible par 200
print(C)
```
...
le revenu des ménages qui sont de taille 1 a une Moyenne de 12 000 et un ecart type de 3 000 avec Rmin et Rmax


# Introduction

Ce document a pour objectif de faire la synthèse d'une  méthodes pour l'ajout de la variable revenu à une population synthétique qui ne contient pas cette variable. En revanche, il est connu les données aggrégées de cette variable pour certaines variables qualitatives. Cette méthode est implémentée en R. Elle est donnée sous la forme d'un exemple qui permet de tester différentes méthodologies. Dans la suite, nous présentons le cas d'étude, puis la méthodologie et enfi    
Cette propriété de base varie selon la taille des ménage selon les régles suivantes



```{r}
pa1=0.2 # proportion de personnes ayant l'age 1, on ne se sert pas ce cette avrailbe

C[C$a==M_a[1] & C$t==M_t[1] & C$m==M_m[1],]$p=0.2*0.4*0.1
C[C$a==M_a[1] & C$t==M_t[1] & C$m==M_m[2],]$p=0.2*0.4*0.9
C[C$a==M_a[1] & C$t==M_t[2]  & C$m==M_m[1],]$p=0.2*0.3*0.15
C[C$a==M_a[1] & C$t==M_t[2] & C$m==M_m[2],]$p=0.2*0.3*0.85
C[C$a==M_a[1] & C$t==M_t[3] & C$m==M_m[1],]$p=0.2*0.2*0.5
C[C$a==M_a[1] & C$t==M_t[3] & C$m==M_m[2],]$p=0.2*0.2*0.5
C[C$a==M_a[1] & C$t==M_t[4] & C$m==M_m[1],]$p=0.2*0.1*0.6
C[C$a==M_a[1] & C$t==M_t[4] & C$m==M_m[2],]$p=0.2*0.1*0.4
print(C)
```


60% qui ont entre 30 et 60 ans
...
```{r}
pa1=0.1 # proportion de personnes ayant l'age 1, on ne se sert pas ce cette avrailbe

C[C$a==M_a[2] & C$t==M_t[1] & C$m==M_m[1],]$p=0.2*0.7*0.1
C[C$a==M_a[2] & C$t==M_t[1] & C$m==M_m[2],]$p=0.2*0.7*0.9
C[C$a==M_a[2] & C$t==M_t[2]  & C$m==M_m[1],]$p=0.2*0.3*0.15
C[C$a==M_a[2] & C$t==M_t[2] & C$m==M_m[2],]$p=0.2*0.3*0.85
C[C$a==M_a[2] & C$t==M_t[3] & C$m==M_m[1],]$p=0.2*0.2*0.5
C[C$a==M_a[2] & C$t==M_t[3] & C$m==M_m[2],]$p=0.2*0.2*0.5
C[C$a==M_a[2] & C$t==M_t[4] & C$m==M_m[1],]$p=0.2*0.1*0.6
C[C$a==M_a[2] & C$t==M_t[4] & C$m==M_m[2],]$p=0.2*0.1*0.4
print(C)

############## ARRET LE 4 OCTOBRE 2021 #################
